...
# fetch data 
gene_list <- c("CTHRC1", "COL1A1", "COL3A1")
...
write_csv(test, here("final/csv/fibro_related_expression_check_test.csv"))
...
merge
write_csv(merge, here("final/csv/fibro_related_expression_check.csv"))
