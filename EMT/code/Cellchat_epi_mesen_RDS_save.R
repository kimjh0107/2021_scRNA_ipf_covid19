...
df <- readRDS(here("EMT/RDS/epi_mesen_subset.RDS"))
...
saveRDS(cellchat_control, here("EMT/RDS/snRNA_cellchat_epi_mesen_control.RDS"))
cellchat_covid <- aggregateNet(cellchat_covid)
saveRDS(cellchat_covid, here("EMT/RDS/snRNA_cellchat_epi_mesen_covid.RDS"))
cellchat_ipf <- aggregateNet(cellchat_ipf)
saveRDS(cellchat_ipf, here("EMT/RDS/snRNA_cellchat_epi_mesen_ipf.RDS"))
