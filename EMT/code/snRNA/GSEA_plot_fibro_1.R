...
mesenchymal <- subset(mesenchymal, subset = cell_type_submain == "Fibroblasts")
...
ggsave(here("EMT/figure/snRNA_GSEA_EMT_fibro.pdf"), width = 20, height = 5)
...
ggarrange(p1,p2, ncol = 2, nrow = 1)
ggsave(here("EMT/figure/snRNA_GSEA_TGFB_fibro.pdf"), width = 20, height = 5)
...
ggarrange(p1,p2, ncol = 2, nrow = 1)
ggsave(here("EMT/figure/snRNA_GSEA_NOTCH_fibro.pdf"), width = 20, height = 5)
...
ggarrange(p1,p2, ncol = 2, nrow = 1)
ggsave(here("EMT/figure/snRNA_GSEA_TNFA_fibro.pdf"), width = 20, height = 5)
...
ggarrange(p1,p2, ncol = 2, nrow = 1)
ggsave(here("EMT/figure/snRNA_GSEA_WNT_fibro.pdf"), width = 20, height = 5)
