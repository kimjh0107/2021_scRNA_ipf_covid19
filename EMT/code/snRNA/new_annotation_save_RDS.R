...
emt@meta.data$new_submain2 <- ifelse(emt@meta.data$seurat_clusters %in% c(15,14,7,12), "Myofibroblasts", emt@meta.data$new_submain2)
emt@meta.data$new_submain2 <- ifelse(emt@meta.data$seurat_clusters %in% c(3), "Fibroblasts", emt@meta.data$new_submain2)
...
emt@meta.data$new_submain3 <- ifelse(emt@meta.data$seurat_clusters %in% c(21,13,6,4,10,9), "Myofibroblasts", emt@meta.data$new_submain3)
emt@meta.data$new_submain3 <- ifelse(emt@meta.data$seurat_clusters %in% c(17,8,5,1), "Fibroblasts", emt@meta.data$new_submain3)
