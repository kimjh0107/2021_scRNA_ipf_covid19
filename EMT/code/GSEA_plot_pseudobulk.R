...
mesenchymal <- readRDS(here("EMT/RDS/df.RDS"))
...
ggsave(here("EMT/figure/GSEA_bulk_EMT_fibro.pdf"), width = 20, height = 5)
...
ggarrange(p1,p2,p3, ncol = 3, nrow = 1)
ggsave(here("EMT/figure/GSEA_bulk_TGFB_fibro.pdf"), width = 20, height = 5)
...
ggarrange(p1,p2,p3, ncol = 3, nrow = 1)
ggsave(here("EMT/figure/GSEA_bulk_NOTCH_fibro.pdf"), width = 20, height = 5)
...
ggarrange(p1,p2,p3, ncol = 3, nrow = 1)
ggsave(here("EMT/figure/GSEA_bulk_TNFA_fibro.pdf"), width = 20, height = 5)
...
ggarrange(p1,p2,p3, ncol = 3, nrow = 1)
ggsave(here("EMT/figure/GSEA_bulk_WNT_fibro.pdf"), width = 20, height = 5)
