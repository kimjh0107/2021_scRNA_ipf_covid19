...
mesenchymal <- readRDS(here("EMT/RDS/AT.RDS"))

unique(mesenchymal$new_submain)

mesenchymal <- subset(mesenchymal, subset = new_submain == "AT2")
...
p3 <- plotEnrichment(fgsea_sets[["HALLMARK_EPITHELIAL_MESENCHYMAL_TRANSITION"]],
               ranks_ipf) + labs(title="IPF HALLMARK_EPITHELIAL_MESENCHYMAL_TRANSITION") + theme_classic()

ggarrange(p1,p2,p3, ncol = 3, nrow = 1)
ggsave(here("EMT/figure/GSEA_EMT_at2.pdf"), width = 20, height = 5)
...
p3 <- plotEnrichment(fgsea_sets[["HALLMARK_TGF_BETA_SIGNALING"]],
               ranks_ipf) + labs(title="IPF HALLMARK_TGF_BETA_SIGNALING") + theme_classic()

ggarrange(p1,p2,p3, ncol = 3, nrow = 1)
ggsave(here("EMT/figure/GSEA_TGFB_at2.pdf"), width = 20, height = 5)
...
p3 <- plotEnrichment(fgsea_sets[["HALLMARK_NOTCH_SIGNALING"]],
               ranks_ipf) + labs(title="IPF HALLMARK_NOTCH_SIGNALING") + theme_classic()

ggarrange(p1,p2,p3, ncol = 3, nrow = 1)
ggsave(here("EMT/figure/GSEA_NOTCH_at2.pdf"), width = 20, height = 5)
...
p3 <- plotEnrichment(fgsea_sets[["HALLMARK_TNFA_SIGNALING_VIA_NFKB"]],
               ranks_ipf) + labs(title="IPF HALLMARK_TNFA_SIGNALING_VIA_NFKB") + theme_classic()

ggarrange(p1,p2,p3, ncol = 3, nrow = 1)
ggsave(here("EMT/figure/GSEA_TNFA_at2.pdf"), width = 20, height = 5)
...
p3 <- plotEnrichment(fgsea_sets[["HALLMARK_WNT_BETA_CATENIN_SIGNALING"]],
               ranks_ipf) + labs(title="IPF HALLMARK_WNT_BETA_CATENIN_SIGNALING") + theme_classic()

ggarrange(p1,p2,p3, ncol = 3, nrow = 1)
ggsave(here("EMT/figure/GSEA_WNT_at2.pdf"), width = 20, height = 5)
