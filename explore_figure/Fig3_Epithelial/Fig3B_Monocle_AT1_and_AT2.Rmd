...
```{r}
FeaturePlot(AT1.cds, c("AT1"), pt.size = 0.1) & scale_color_viridis_c()
ggsave(here('explore_figure/Fig3/AT1_monocle.pdf'))

FeaturePlot(AT2.cds, c("AT2"), pt.size = 0.1) & scale_color_viridis_c()
ggsave(here('explore_figure/Fig3/AT2_monocle.pdf'))

FeaturePlot(AT1.cds, c("AT1"), pt.size = 0.1)
