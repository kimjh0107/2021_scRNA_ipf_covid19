---
title: "Dotplot_subset_covid_ipf"
...
```{r}
unique(pathway_subset$Diagnosis)
```

# IPF $ COVID 에 대해 subset진행 
```{r}
...
write.csv(topmarkers_pathway_COVID, "pathway_COVID_markers.csv", row.names = TRUE)
write.csv(topmarkers_pathway_IPF, "pathway_IPF_markers.csv", row.names = TRUE)
```
